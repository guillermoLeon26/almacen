    ...
    <form class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10" style="padding-bottom: 6px;">
          <input class="form-control" type="text" id="codigo" value="{{$producto->codigo}}">
        </div>
      </div>
      ...
      <div class="form-group" style="padding-top: 6px;">
        ...
        <div class="col-sm-10">
          <textarea class="form-control" id="descripcion" rows="3" style="margin-top: 6px;">{{ $producto->descripcion }}
          </textarea>
        </div>
      </div>
    </form>
