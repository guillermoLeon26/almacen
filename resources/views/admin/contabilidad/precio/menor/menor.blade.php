...
@section('css')
  @include('admin.contabilidad.precio.menor.css.css')
@endsection
...
@section('contenido')
  ...
  @include('admin.contabilidad.precio.menor.include.modalPrecioPorMenor')

@endsection

@push('js')
  @include('admin.contabilidad.precio.menor.js.js')
  @include('admin.contabilidad.precio.menor.js.jsPrecioPorMenor')
@endpush